...
SIGNAL NEW_PRICE 			: INTEGER RANGE 0 TO 995 := 0;
SIGNAL PRICE 				: INTEGER RANGE 0 TO 995;
SIGNAL TENDER				: INTEGER RANGE 0 TO 995 := 0;
SIGNAL CHANGE				: INTEGER RANGE 0 TO 995;

SIGNAL NEW_PRICE_ONES			: INTEGER RANGE 0 TO 9;
SIGNAL NEW_PRICE_TENTHS			: INTEGER RANGE 0 TO 9;
SIGNAL NEW_PRICE_HUNDREDTHS	: INTEGER RANGE 0 TO 9;
...
END PROCESS;
	...
	NEW_PRICE_ONES <= NEW_PRICE / 100 WHEN STATE = STATE4 ELSE
			 TENDER / 100 WHEN STATE = STATE4 ELSE
			 TENDER / 100 WHEN STATE = STATE4 ELSE
			 TENDER / 100 WHEN STATE = STATE4 ELSE
			 TENDER / 100 WHEN STATE = STATE4 ELSE
			 0;
	NEW_PRICE_TENTHS <= (NEW_PRICE MOD 100) / 10 WHEN STATE = STATE4 ELSE
			 (TENDER MOD 100) / 10 WHEN STATE = STATE4 ELSE
			 (TENDER MOD 100) / 10 WHEN STATE = STATE4 ELSE
			 (TENDER MOD 100) / 10 WHEN STATE = STATE4 ELSE
			 (TENDER MOD 100) / 10 WHEN STATE = STATE4 ELSE
			 0;
	NEW_PRICE_HUNDREDTHS <= (NEW_PRICE MOD 10) WHEN STATE = STATE4 ELSE
			 (TENDER MOD 10) WHEN STATE = STATE4 ELSE
			 (TENDER MOD 10) WHEN STATE = STATE4 ELSE
			 (TENDER MOD 10) WHEN STATE = STATE4 ELSE
			 (TENDER MOD 10) WHEN STATE = STATE4 ELSE
			 0;
	...
	HEX_COUNTER1 <= convertToHex(PRICE_ONES) WHEN STATE = STATE0 ELSE
						...
						convertToHex(PRICE_ONES) WHEN STATE = STATE3 ELSE
						convertToHex(NEW_PRICE_ONES) WHEN STATE = STATE4 ELSE
						"1111111";	
	HEX_COUNTER2 <= convertToHex(PRICE_TENTHS) WHEN STATE = STATE0 ELSE
						...
						convertToHex(PRICE_TENTHS) WHEN STATE = STATE3 ELSE
						convertToHex(NEW_PRICE_TENTHS) WHEN STATE = STATE4 ELSE
						"1111111";
	HEX_COUNTER3 <= convertToHex(PRICE_HUNDREDTHS) WHEN STATE = STATE0 ELSE
						...
						convertToHex(PRICE_HUNDREDTHS) WHEN STATE = STATE3 ELSE
						convertToHex(NEW_PRICE_HUNDREDTHS) WHEN STATE = STATE4 ELSE
						"1111111";	
